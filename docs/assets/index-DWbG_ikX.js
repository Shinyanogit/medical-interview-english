 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gR(t,e){const n=Ai(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),s=n.getOptions();if(Nr(s,e??{}))return i;Gt(i,"already-initialized")}return n.initialize({options:e})}function yR(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Mn);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function _R(t,e,n){const r=zr(t);J(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=TE(e),{host:o,port:l}=vR(e),u=l===null?"":`:${l}`,c={url:`${s}//${o}${u}/`},f=Object.freeze({host:o,port:l,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})});if(!r._canInitEmulator){J(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),J(Nr(c,r.config.emulator)&&Nr(f,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=c,r.emulatorConfig=f,r.settings.appVerificationDisabledForTesting=!0,Is(o)?(Kw(`${s}//${o}${u}`),Gw("Auth",!0)):wR()}function TE(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function vR(t){const e=TE(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:ty(r.substr(s.length+1))}}else{const[s,o]=r.split(":");return{host:s,port:ty(o)}}}function ty(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function wR(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bP="__/auth/handler",MP="emulator/auth/handler",FP=encodeURIComponent("fac");async function ly(t,e,n,r,i,s){J(t.config.authDomain,t,"auth-domain-config-required"),J(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:Ss,eventId:i};if(e instanceof Bf){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",vC(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,p]of Object.entries({}))o[f]=p}if(e instanceof da){const f=e.getScopes().filter(p=>p!=="");f.length>0&&(o.scopes=f.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const u=await t._getAppCheckToken(),c=u?`#${FP}=${encodeURIComponent(u)}`:"";return`${UP(t)}?${ua(l).slice(1)}${c}`}function UP({config:t}){return t.emulator?bf(t,MP):`https://${t.authDomain}/${bP}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var FE,lo,UE,vl,md,jE,BE,zE;(function(){var t,e=Object.defineProperty;function n(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Qa=="object"&&Qa];for(var h=0;h<a.length;++h){var d=a[h];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var r=n(this);function i(a,h){if(h)e:{var d=r;a=a.split(".");for(var g=0;g<a.length-1;g++){var D=a[g];if(!(D in d))break e;d=d[D]}a=a[a.length-1],g=d[a],h=h(g),h!=g&&h!=null&&e(d,a,{configurable:!0,writable:!0,value:h})}}i("Symbol.dispose",function(a){return a||Symbol("Symbol.dispose")}),i("Array.prototype.values",function(a){return a||function(){return this[Symbol.iterator]()}}),i("Object.entries",function(a){return a||function(h){var d=[],g;for(g in h)Object.prototype.hasOwnProperty.call(h,g)&&d.push([g,h[g]]);return d}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var s=s||{},o=this||self;function l(a){var h=typeof a;return h=="object"&&a!=null||h=="function"}function u(a,h,d){return a.call.apply(a.bind,arguments)}function c(a,h,d){return c=u,c.apply(null,arguments)}function f(a,h){var d=Array.prototype.slice.call(arguments,1);return function(){var g=d.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function p(a,h){function d(){}d.prototype=h.prototype,a.Z=h.prototype,a.prototype=new d,a.prototype.constructor=a,a.Ob=function(g,D,L){for(var z=Array(arguments.length-2),ie=2;ie<arguments.length;ie++)z[ie-2]=arguments[ie];return h.prototype[D].apply(g,z)}}var m=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?a=>a&&AsyncContext.Snapshot.wrap(a):a=>a;function I(a){const h=a.length;if(h>0){const d=Array(h);for(let g=0;g<h;g++)d[g]=a[g];return d}return[]}function N(a,h){for(let g=1;g<arguments.length;g++){const D=arguments[g];var d=typeof D;if(d=d!="object"?d:D?Array.isArray(D)?"array":d:"null",d=="array"||d=="object"&&typeof D.length=="number"){d=a.length||0;const L=D.length||0;a.length=d+L;for(let z=0;z<L;z++)a[d+z]=D[z]}else a.push(D)}}class k{constructor(h,d){this.i=h,this.j=d,this.h=0,this.g=null}get(){let h;return this.h>0?(this.h--,h=this.g,this.g=h.next,h.next=null):h=this.i(),h}}function P(a){o.setTimeout(()=>{throw a},0)}function w(){var a=v;let h=null;return a.g&&(h=a.g,a.g=a.g.next,a.g||(a.h=null),h.next=null),h}class _{constructor(){this.h=this.g=null}add(h,d){const g=S.get();g.set(h,d),this.h?this.h.next=g:this.g=g,this.h=g}}var S=new k(()=>new V,a=>a.reset());class V{constructor(){this.next=this.g=this.h=null}set(h,d){this.h=h,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let M,U=!1,v=new _,y=()=>{const a=Promise.resolve(void 0);M=()=>{a.then(E)}};function E(){for(var a;a=w();){try{a.h.call(a.g)}catch(d){P(d)}var h=S;h.j(a),h.h<100&&(h.h++,a.next=h.g,h.g=a)}U=!1}function A(){this.u=this.u,this.C=this.C}A.prototype.u=!1,A.prototype.dispose=function(){this.u||(this.u=!0,this.N())},A.prototype[Symbol.dispose]=function(){this.dispose()},A.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function C(a,h){this.type=a,this.g=this.target=h,this.defaultPrevented=!1}C.prototype.h=function(){this.defaultPrevented=!0};var x=function(){if(!o.addEventListener||!Object.defineProperty)return!1;var a=!1,h=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};o.addEventListener("test",d,h),o.removeEventListener("test",d,h)}catch{}return a}();function T(a){return/^[\s\xa0]*$/.test(a)}function re(a,h){C.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a&&this.init(a,h)}p(re,C),re.prototype.init=function(a,h){const d=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement,this.g=h,h=a.relatedTarget,h||(d=="mouseover"?h=a.fromElement:d=="mouseout"&&(h=a.toElement)),this.relatedTarget=h,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=a.pointerType,this.state=a.state,this.i=a,a.defaultPrevented&&re.Z.h.call(this)},re.prototype.h=function(){re.Z.h.call(this);const a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var de="closure_listenable_"+(Math.random()*1e6|0),it=0;function Pt(a,h,d,g,D){this.listener=a,this.proxy=null,this.src=h,this.type=d,this.capture=!!g,this.ha=D,this.key=++it,this.da=this.fa=!1}function $(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function B(a,h,d){for(const g in a)h.call(d,a[g],g,a)}function Q(a,h){for(const d in a)h.call(void 0,a[d],d,a)}function W(a){const h={};for(const d in a)h[d]=a[d];return h}const ge="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function An(a,h){let d,g;for(let D=1;D<arguments.length;D++){g=arguments[D];for(d in g)a[d]=g[d];for(let L=0;L<ge.length;L++)d=ge[L],Object.prototype.hasOwnProperty.call(g,d)&&(a[d]=g[d])}}function vt(a){this.src=a,this.g={},this.h=0}vt.prototype.add=function(a,h,d,g,D){const L=a.toString();a=this.g[L],a||(a=this.g[L]=[],this.h++);const z=kt(a,h,g,D);return z>-1?(h=a[z],d||(h.fa=!1)):(h=new Pt(h,this.src,L,!!g,D),h.fa=d,a.push(h)),h};function Cn(a,h){const d=h.type;if(d in a.g){var g=a.g[d],D=Array.prototype.indexOf.call(g,h,void 0),L;(L=D>=0)&&Array.prototype.splice.call(g,D,1),L&&($(h),a.g[d].length==0&&(delete a.g[d],a.h--))}}function kt(a,h,d,g){for(let D=0;D<a.length;++D){const L=a[D];if(!L.da&&L.listener==h&&L.capture==!!d&&L.ha==g)return D}return-1}var ce="closure_lm_"+(Math.random()*1e6|0),me={};function X(a,h,d,g,D){if(Array.isArray(h)){for(let L=0;L<h.length;L++)X(a,h[L],d,g,D);return null}return d=ne(d),a&&a[de]?a.J(h,d,l(g)?!!g.capture:!1,D):wt(a,h,d,!1,g,D)}function wt(a,h,d,g,D,L){if(!h)throw Error("Invalid event type");const z=l(D)?!!D.capture:!!D;let ie=fe(a);if(ie||(a[ce]=ie=new vt(a)),d=ie.add(h,d,g,z,L),d.proxy)return d;if(g=ue(),d.proxy=g,g.src=a,g.listener=d,a.addEventListener)x||(D=z),D===void 0&&(D=!1),a.addEventListener(h.toString(),g,D);else if(a.attachEvent)a.attachEvent(Qn(h.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return d}function ue(){function a(d){return h.call(a.src,a.listener,d)}const h=Wr;return a}function Rn(a,h,d,g,D){if(Array.isArray(h))for(var L=0;L<h.length;L++)Rn(a,h[L],d,g,D);else g=l(g)?!!g.capture:!!g,d=ne(d),a&&a[de]?(a=a.i,L=String(h).toString(),L in a.g&&(h=a.g[L],d=kt(h,d,g,D),d>-1&&($(h[d]),Array.prototype.splice.call(h,d,1),h.length==0&&(delete a.g[L],a.h--)))):a&&(a=fe(a))&&(h=a.g[h.toString()],a=-1,h&&(a=kt(h,d,g,D)),(d=a>-1?h[a]:null)&&Pn(d))}function Pn(a){if(typeof a!="number"&&a&&!a.da){var h=a.src;if(h&&h[de])Cn(h.i,a);else{var d=a.type,g=a.proxy;h.removeEventListener?h.removeEventListener(d,g,a.capture):h.detachEvent?h.detachEvent(Qn(d),g):h.addListener&&h.removeListener&&h.removeListener(g),(d=fe(h))?(Cn(d,a),d.h==0&&(d.src=null,h[ce]=null)):$(a)}}}function Qn(a){return a in me?me[a]:me[a]="on"+a}function Wr(a,h){if(a.da)a=!0;else{h=new re(h,this);const d=a.listener,g=a.ha||a.src;a.fa&&Pn(a),a=d.call(g,h)}return a}function fe(a){return a=a[ce],a instanceof vt?a:null}var G="__closure_events_fn_"+(Math.random()*1e9>>>0);function ne(a){return typeof a=="function"?a:(a[G]||(a[G]=function(h){return a.handleEvent(h)}),a[G])}function we(){A.call(this),this.i=new vt(this),this.M=this,this.G=null}p(we,A),we.prototype[de]=!0,we.prototype.removeEventListener=function(a,h,d,g){Rn(this,a,h,d,g)};function Ke(a,h){var d,g=a.G;if(g)for(d=[];g;g=g.G)d.push(g);if(a=a.M,g=h.type||h,typeof h=="string")h=new C(h,a);else if(h instanceof C)h.target=h.target||a;else{var D=h;h=new C(g,a),An(h,D)}D=!0;let L,z;if(d)for(z=d.length-1;z>=0;z--)L=h.g=d[z],D=Qt(L,g,!0,h)&&D;if(L=h.g=a,D=Qt(L,g,!0,h)&&D,D=Qt(L,g,!1,h)&&D,d)for(z=0;z<d.length;z++)L=h.g=d[z],D=Qt(L,g,!1,h)&&D}we.prototype.N=function(){if(we.Z.N.call(this),this.i){var a=this.i;for(const h in a.g){const d=a.g[h];for(let g=0;g<d.length;g++)$(d[g]);delete a.g[h],a.h--}}this.G=null},we.prototype.J=function(a,h,d,g){return this.i.add(String(a),h,!1,d,g)},we.prototype.K=function(a,h,d,g){return this.i.add(String(a),h,!0,d,g)};function Qt(a,h,d,g){if(h=a.i.g[String(h)],!h)return!0;h=h.concat();let D=!0;for(let L=0;L<h.length;++L){const z=h[L];if(z&&!z.da&&z.capture==d){const ie=z.listener,je=z.ha||z.src;z.fa&&Cn(a.i,z),D=ie.call(je,g)!==!1&&D}}return D&&!g.defaultPrevented}function qI(a,h){if(typeof a!="function")if(a&&typeof a.handleEvent=="function")a=c(a.handleEvent,a);else throw Error("Invalid listener argument");return Number(h)>2147483647?-1:o.setTimeout(a,h||0)}function xp(a){a.g=qI(()=>{a.g=null,a.i&&(a.i=!1,xp(a))},a.l);const h=a.h;a.h=null,a.m.apply(null,h)}class KI extends A{constructor(h,d){super(),this.m=h,this.l=d,this.h=null,this.i=!1,this.g=null}j(h){this.h=arguments,this.g?this.i=!0:xp(this)}N(){super.N(),this.g&&(o.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function xs(a){A.call(this),this.h=a,this.g={}}p(xs,A);var Dp=[];function Op(a){B(a.g,function(h,d){this.g.hasOwnProperty(d)&&Pn(h)},a),a.g={}}xs.prototype.N=function(){xs.Z.N.call(this),Op(this)},xs.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var oc=o.JSON.stringify,GI=o.JSON.parse,QI=class{stringify(a){return o.JSON.stringify(a,void 0)}parse(a){return o.JSON.parse(a,void 0)}};function Vp(){}function Lp(){}var Ds={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function ac(){C.call(this,"d")}p(ac,C);function lc(){C.call(this,"c")}p(lc,C);var qr={},bp=null;function wa(){return bp=bp||new we}qr.Ia="serverreachability";function Mp(a){C.call(this,qr.Ia,a)}p(Mp,C);function Os(a){const h=wa();Ke(h,new Mp(h))}qr.STAT_EVENT="statevent";function Fp(a,h){C.call(this,qr.STAT_EVENT,a),this.stat=h}p(Fp,C);function ft(a){const h=wa();Ke(h,new Fp(h,a))}qr.Ja="timingevent";function Up(a,h){C.call(this,qr.Ja,a),this.size=h}p(Up,C);function Vs(a,h){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return o.setTimeout(function(){a()},h)}function Ls(){this.g=!0}Ls.prototype.ua=function(){this.g=!1};function YI(a,h,d,g,D,L){a.info(function(){if(a.g)if(L){var z="",ie=L.split("&");for(let ve=0;ve<ie.length;ve++){var je=ie[ve].split("=");if(je.length>1){const Ge=je[0];je=je[1];const un=Ge.split("_");z=un.length>=2&&un[1]=="type"?z+(Ge+"="+je+"&"):z+(Ge+"=redacted&")}}}else z=null;else z=L;return"XMLHTTP REQ ("+g+") [attempt "+D+"]: "+h+`
`+d+`
`+z})}function XI(a,h,d,g,D,L,z){a.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+D+"]: "+h+`
`+d+`
`+L+" "+z})}function Ni(a,h,d,g){a.info(function(){return"XMLHTTP TEXT ("+h+"): "+ZI(a,d)+(g?" "+g:"")})}function JI(a,h){a.info(function(){return"TIMEOUT: "+h})}Ls.prototype.info=function(){};function ZI(a,h){if(!a.g)return h;if(!h)return null;try{const L=JSON.parse(h);if(L){for(a=0;a<L.length;a++)if(Array.isArray(L[a])){var d=L[a];if(!(d.length<2)){var g=d[1];if(Array.isArray(g)&&!(g.length<1)){var D=g[0];if(D!="noop"&&D!="stop"&&D!="close")for(let z=1;z<g.length;z++)g[z]=""}}}}return oc(L)}catch{return h}}var Ea={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},jp={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},Bp;function uc(){}p(uc,Vp),uc.prototype.g=function(){return new XMLHttpRequest},Bp=new uc;function bs(a){return encodeURIComponent(String(a))}function e0(a){var h=1;a=a.split(":");const d=[];for(;h>0&&a.length;)d.push(a.shift()),h--;return a.length&&d.push(a.join(":")),d}function Yn(a,h,d,g){this.j=a,this.i=h,this.l=d,this.S=g||1,this.V=new xs(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new zp}function zp(){this.i=null,this.g="",this.h=!1}var $p={},cc={};function hc(a,h,d){a.M=1,a.A=Ia(ln(h)),a.u=d,a.R=!0,Hp(a,null)}function Hp(a,h){a.F=Date.now(),Ta(a),a.B=ln(a.A);var d=a.B,g=a.S;Array.isArray(g)||(g=[String(g)]),rm(d.i,"t",g),a.C=0,d=a.j.L,a.h=new zp,a.g=Em(a.j,d?h:null,!a.u),a.P>0&&(a.O=new KI(c(a.Y,a,a.g),a.P)),h=a.V,d=a.g,g=a.ba;var D="readystatechange";Array.isArray(D)||(D&&(Dp[0]=D.toString()),D=Dp);for(let L=0;L<D.length;L++){const z=X(d,D[L],g||h.handleEvent,!1,h.h||h);if(!z)break;h.g[z.key]=z}h=a.J?W(a.J):{},a.u?(a.v||(a.v="POST"),h["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.B,a.v,a.u,h)):(a.v="GET",a.g.ea(a.B,a.v,null,h)),Os(),YI(a.i,a.v,a.B,a.l,a.S,a.u)}Yn.prototype.ba=function(a){a=a.target;const h=this.O;h&&Zn(a)==3?h.j():this.Y(a)},Yn.prototype.Y=function(a){try{if(a==this.g)e:{const ie=Zn(this.g),je=this.g.ya(),ve=this.g.ca();if(!(ie<3)&&(ie!=3||this.g&&(this.h.h||this.g.la()||cm(this.g)))){this.K||ie!=4||je==7||(je==8||ve<=0?Os(3):Os(2)),dc(this);var h=this.g.ca();this.X=h;var d=t0(this);if(this.o=h==200,XI(this.i,this.v,this.B,this.l,this.S,ie,h),this.o){if(this.U&&!this.L){t:{if(this.g){var g,D=this.g;if((g=D.g?D.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!T(g)){var L=g;break t}}L=null}if(a=L)Ni(this.i,this.l,a,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,fc(this,a);else{this.o=!1,this.m=3,ft(12),Kr(this),Ms(this);break e}}if(this.R){a=!0;let Ge;for(;!this.K&&this.C<d.length;)if(Ge=n0(this,d),Ge==cc){ie==4&&(this.m=4,ft(14),a=!1),Ni(this.i,this.l,null,"[Incomplete Response]");break}else if(Ge==$p){this.m=4,ft(15),Ni(this.i,this.l,d,"[Invalid Chunk]"),a=!1;break}else Ni(this.i,this.l,Ge,null),fc(this,Ge);if(Wp(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ie!=4||d.length!=0||this.h.h||(this.m=1,ft(16),a=!1),this.o=this.o&&a,!a)Ni(this.i,this.l,d,"[Invalid Chunked Response]"),Kr(this),Ms(this);else if(d.length>0&&!this.W){this.W=!0;var z=this.j;z.g==this&&z.aa&&!z.P&&(z.j.info("Great, no buffering proxy detected. Bytes received: "+d.length),Ec(z),z.P=!0,ft(11))}}else Ni(this.i,this.l,d,null),fc(this,d);ie==4&&Kr(this),this.o&&!this.K&&(ie==4?ym(this.j,this):(this.o=!1,Ta(this)))}else g0(this.g),h==400&&d.indexOf("Unknown SID")>0?(this.m=3,ft(12)):(this.m=0,ft(13)),Kr(this),Ms(this)}}}catch{}finally{}};function t0(a){if(!Wp(a))return a.g.la();const h=cm(a.g);if(h==="")return"";let d="";const g=h.length,D=Zn(a.g)==4;if(!a.h.i){if(typeof TextDecoder>"u")return Kr(a),Ms(a),"";a.h.i=new o.TextDecoder}for(let L=0;L<g;L++)a.h.h=!0,d+=a.h.i.decode(h[L],{stream:!(D&&L==g-1)});return h.length=0,a.h.g+=d,a.C=0,a.h.g}function Wp(a){return a.g?a.v=="GET"&&a.M!=2&&a.j.Aa:!1}function n0(a,h){var d=a.C,g=h.indexOf(`
`,d);return g==-1?cc:(d=Number(h.substring(d,g)),isNaN(d)?$p:(g+=1,g+d>h.length?cc:(h=h.slice(g,g+d),a.C=g+d,h)))}Yn.prototype.cancel=function(){this.K=!0,Kr(this)};function Ta(a){a.T=Date.now()+a.H,qp(a,a.H)}function qp(a,h){if(a.D!=null)throw Error("WatchDog timer not null");a.D=Vs(c(a.aa,a),h)}function dc(a){a.D&&(o.clearTimeout(a.D),a.D=null)}Yn.prototype.aa=function(){this.D=null;const a=Date.now();a-this.T>=0?(JI(this.i,this.B),this.M!=2&&(Os(),ft(17)),Kr(this),this.m=2,Ms(this)):qp(this,this.T-a)};function Ms(a){a.j.I==0||a.K||ym(a.j,a)}function Kr(a){dc(a);var h=a.O;h&&typeof h.dispose=="function"&&h.dispose(),a.O=null,Op(a.V),a.g&&(h=a.g,a.g=null,h.abort(),h.dispose())}function fc(a,h){try{var d=a.j;if(d.I!=0&&(d.g==a||pc(d.h,a))){if(!a.L&&pc(d.h,a)&&d.I==3){try{var g=d.Ba.g.parse(h)}catch{g=null}if(Array.isArray(g)&&g.length==3){var D=g;if(D[0]==0){e:if(!d.v){if(d.g)if(d.g.F+3e3<a.F)Pa(d),Ca(d);else break e;wc(d),ft(18)}}else d.xa=D[1],0<d.xa-d.K&&D[2]<37500&&d.F&&d.A==0&&!d.C&&(d.C=Vs(c(d.Va,d),6e3));Qp(d.h)<=1&&d.ta&&(d.ta=void 0)}else Qr(d,11)}else if((a.L||d.g==a)&&Pa(d),!T(h))for(D=d.Ba.g.parse(h),h=0;h<D.length;h++){let ve=D[h];const Ge=ve[0];if(!(Ge<=d.K))if(d.K=Ge,ve=ve[1],d.I==2)if(ve[0]=="c"){d.M=ve[1],d.ba=ve[2];const un=ve[3];un!=null&&(d.ka=un,d.j.info("VER="+d.ka));const Yr=ve[4];Yr!=null&&(d.za=Yr,d.j.info("SVER="+d.za));const er=ve[5];er!=null&&typeof er=="number"&&er>0&&(g=1.5*er,d.O=g,d.j.info("backChannelRequestTimeoutMs_="+g)),g=d;const tr=a.g;if(tr){const Na=tr.g?tr.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Na){var L=g.h;L.g||Na.indexOf("spdy")==-1&&Na.indexOf("quic")==-1&&Na.indexOf("h2")==-1||(L.j=L.l,L.g=new Set,L.h&&(mc(L,L.h),L.h=null))}if(g.G){const Tc=tr.g?tr.g.getResponseHeader("X-HTTP-Session-Id"):null;Tc&&(g.wa=Tc,Te(g.J,g.G,Tc))}}d.I=3,d.l&&d.l.ra(),d.aa&&(d.T=Date.now()-a.F,d.j.info("Handshake RTT: "+d.T+"ms")),g=d;var z=a;if(g.na=wm(g,g.L?g.ba:null,g.W),z.L){Yp(g.h,z);var ie=z,je=g.O;je&&(ie.H=je),ie.D&&(dc(ie),Ta(ie)),g.g=z}else mm(g);d.i.length>0&&Ra(d)}else ve[0]!="stop"&&ve[0]!="close"||Qr(d,7);else d.I==3&&(ve[0]=="stop"||ve[0]=="close"?ve[0]=="stop"?Qr(d,7):vc(d):ve[0]!="noop"&&d.l&&d.l.qa(ve),d.A=0)}}Os(4)}catch{}}var r0=class{constructor(a,h){this.g=a,this.map=h}};function Kp(a){this.l=a||10,o.PerformanceNavigationTiming?(a=o.performance.getEntriesByType("navigation"),a=a.length>0&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(o.chrome&&o.chrome.loadTimes&&o.chrome.loadTimes()&&o.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function Gp(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Qp(a){return a.h?1:a.g?a.g.size:0}function pc(a,h){return a.h?a.h==h:a.g?a.g.has(h):!1}function mc(a,h){a.g?a.g.add(h):a.h=h}function Yp(a,h){a.h&&a.h==h?a.h=null:a.g&&a.g.has(h)&&a.g.delete(h)}Kp.prototype.cancel=function(){if(this.i=Xp(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function Xp(a){if(a.h!=null)return a.i.concat(a.h.G);if(a.g!=null&&a.g.size!==0){let h=a.i;for(const d of a.g.values())h=h.concat(d.G);return h}return I(a.i)}var Jp=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function i0(a,h){if(a){a=a.split("&");for(let d=0;d<a.length;d++){const g=a[d].indexOf("=");let D,L=null;g>=0?(D=a[d].substring(0,g),L=a[d].substring(g+1)):D=a[d],h(D,L?decodeURIComponent(L.replace(/\+/g," ")):"")}}}function Xn(a){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let h;a instanceof Xn?(this.l=a.l,Fs(this,a.j),this.o=a.o,this.g=a.g,Us(this,a.u),this.h=a.h,gc(this,im(a.i)),this.m=a.m):a&&(h=String(a).match(Jp))?(this.l=!1,Fs(this,h[1]||"",!0),this.o=js(h[2]||""),this.g=js(h[3]||"",!0),Us(this,h[4]),this.h=js(h[5]||"",!0),gc(this,h[6]||"",!0),this.m=js(h[7]||"")):(this.l=!1,this.i=new zs(null,this.l))}Xn.prototype.toString=function(){const a=[];var h=this.j;h&&a.push(Bs(h,Zp,!0),":");var d=this.g;return(d||h=="file")&&(a.push("//"),(h=this.o)&&a.push(Bs(h,Zp,!0),"@"),a.push(bs(d).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.u,d!=null&&a.push(":",String(d))),(d=this.h)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(Bs(d,d.charAt(0)=="/"?a0:o0,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",Bs(d,u0)),a.join("")},Xn.prototype.resolve=function(a){const h=ln(this);let d=!!a.j;d?Fs(h,a.j):d=!!a.o,d?h.o=a.o:d=!!a.g,d?h.g=a.g:d=a.u!=null;var g=a.h;if(d)Us(h,a.u);else if(d=!!a.h){if(g.charAt(0)!="/")if(this.g&&!this.h)g="/"+g;else{var D=h.h.lastIndexOf("/");D!=-1&&(g=h.h.slice(0,D+1)+g)}if(D=g,D==".."||D==".")g="";else if(D.indexOf("./")!=-1||D.indexOf("/.")!=-1){g=D.lastIndexOf("/",0)==0,D=D.split("/");const L=[];for(let z=0;z<D.length;){const ie=D[z++];ie=="."?g&&z==D.length&&L.push(""):ie==".."?((L.length>1||L.length==1&&L[0]!="")&&L.pop(),g&&z==D.length&&L.push("")):(L.push(ie),g=!0)}g=L.join("/")}else g=D}return d?h.h=g:d=a.i.toString()!=="",d?gc(h,im(a.i)):d=!!a.m,d&&(h.m=a.m),h};function ln(a){return new Xn(a)}function Fs(a,h,d){a.j=d?js(h,!0):h,a.j&&(a.j=a.j.replace(/:$/,""))}function Us(a,h){if(h){if(h=Number(h),isNaN(h)||h<0)throw Error("Bad port number "+h);a.u=h}else a.u=null}function gc(a,h,d){h instanceof zs?(a.i=h,c0(a.i,a.l)):(d||(h=Bs(h,l0)),a.i=new zs(h,a.l))}function Te(a,h,d){a.i.set(h,d)}function Ia(a){return Te(a,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),a}function js(a,h){return a?h?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function Bs(a,h,d){return typeof a=="string"?(a=encodeURI(a).replace(h,s0),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function s0(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var Zp=/[#\/\?@]/g,o0=/[#\?:]/g,a0=/[#\?]/g,l0=/[#\?@]/g,u0=/#/g;function zs(a,h){this.h=this.g=null,this.i=a||null,this.j=!!h}function Gr(a){a.g||(a.g=new Map,a.h=0,a.i&&i0(a.i,function(h,d){a.add(decodeURIComponent(h.replace(/\+/g," ")),d)}))}t=zs.prototype,t.add=function(a,h){Gr(this),this.i=null,a=xi(this,a);let d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(h),this.h+=1,this};function em(a,h){Gr(a),h=xi(a,h),a.g.has(h)&&(a.i=null,a.h-=a.g.get(h).length,a.g.delete(h))}function tm(a,h){return Gr(a),h=xi(a,h),a.g.has(h)}t.forEach=function(a,h){Gr(this),this.g.forEach(function(d,g){d.forEach(function(D){a.call(h,D,g,this)},this)},this)};function nm(a,h){Gr(a);let d=[];if(typeof h=="string")tm(a,h)&&(d=d.concat(a.g.get(xi(a,h))));else for(a=Array.from(a.g.values()),h=0;h<a.length;h++)d=d.concat(a[h]);return d}t.set=function(a,h){return Gr(this),this.i=null,a=xi(this,a),tm(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[h]),this.h+=1,this},t.get=function(a,h){return a?(a=nm(this,a),a.length>0?String(a[0]):h):h};function rm(a,h,d){em(a,h),d.length>0&&(a.i=null,a.g.set(xi(a,h),I(d)),a.h+=d.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],h=Array.from(this.g.keys());for(let g=0;g<h.length;g++){var d=h[g];const D=bs(d);d=nm(this,d);for(let L=0;L<d.length;L++){let z=D;d[L]!==""&&(z+="="+bs(d[L])),a.push(z)}}return this.i=a.join("&")};function im(a){const h=new zs;return h.i=a.i,a.g&&(h.g=new Map(a.g),h.h=a.h),h}function xi(a,h){return h=String(h),a.j&&(h=h.toLowerCase()),h}function c0(a,h){h&&!a.j&&(Gr(a),a.i=null,a.g.forEach(function(d,g){const D=g.toLowerCase();g!=D&&(em(this,g),rm(this,D,d))},a)),a.j=h}function h0(a,h){const d=new Ls;if(o.Image){const g=new Image;g.onload=f(Jn,d,"TestLoadImage: loaded",!0,h,g),g.onerror=f(Jn,d,"TestLoadImage: error",!1,h,g),g.onabort=f(Jn,d,"TestLoadImage: abort",!1,h,g),g.ontimeout=f(Jn,d,"TestLoadImage: timeout",!1,h,g),o.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=a}else h(!1)}function d0(a,h){const d=new Ls,g=new AbortController,D=setTimeout(()=>{g.abort(),Jn(d,"TestPingServer: timeout",!1,h)},1e4);fetch(a,{signal:g.signal}).then(L=>{clearTimeout(D),L.ok?Jn(d,"TestPingServer: ok",!0,h):Jn(d,"TestPingServer: server error",!1,h)}).catch(()=>{clearTimeout(D),Jn(d,"TestPingServer: error",!1,h)})}function Jn(a,h,d,g,D){try{D&&(D.onload=null,D.onerror=null,D.onabort=null,D.ontimeout=null),g(d)}catch{}}function f0(){this.g=new QI}function yc(a){this.i=a.Sb||null,this.h=a.ab||!1}p(yc,Vp),yc.prototype.g=function(){return new Sa(this.i,this.h)};function Sa(a,h){we.call(this),this.H=a,this.o=h,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}p(Sa,we),t=Sa.prototype,t.open=function(a,h){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=a,this.D=h,this.readyState=1,Hs(this)},t.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const h={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};a&&(h.body=a),(this.H||o).fetch(new Request(this.D,h)).then(this.Pa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,$s(this)),this.readyState=0},t.Pa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Hs(this)),this.g&&(this.readyState=3,Hs(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof o.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;sm(this)}else a.text().then(this.Oa.bind(this),this.ga.bind(this))};function sm(a){a.j.read().then(a.Ma.bind(a)).catch(a.ga.bind(a))}t.Ma=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var h=a.value?a.value:new Uint8Array(0);(h=this.B.decode(h,{stream:!a.done}))&&(this.response=this.responseText+=h)}a.done?$s(this):Hs(this),this.readyState==3&&sm(this)}},t.Oa=function(a){this.g&&(this.response=this.responseText=a,$s(this))},t.Na=function(a){this.g&&(this.response=a,$s(this))},t.ga=function(){this.g&&$s(this)};function $s(a){a.readyState=4,a.l=null,a.j=null,a.B=null,Hs(a)}t.setRequestHeader=function(a,h){this.A.append(a,h)},t.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],h=this.h.entries();for(var d=h.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=h.next();return a.join(`\r
`)};function Hs(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(Sa.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function om(a){let h="";return B(a,function(d,g){h+=g,h+=":",h+=d,h+=`\r
`}),h}function _c(a,h,d){e:{for(g in d){var g=!1;break e}g=!0}g||(d=om(d),typeof a=="string"?d!=null&&bs(d):Te(a,h,d))}function De(a){we.call(this),this.headers=new Map,this.L=a||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}p(De,we);var p0=/^https?$/i,m0=["POST","PUT"];t=De.prototype,t.Fa=function(a){this.H=a},t.ea=function(a,h,d,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);h=h?h.toUpperCase():"GET",this.D=a,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():Bp.g(),this.g.onreadystatechange=m(c(this.Ca,this));try{this.B=!0,this.g.open(h,String(a),!0),this.B=!1}catch(L){am(this,L);return}if(a=d||"",d=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var D in g)d.set(D,g[D]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const L of g.keys())d.set(L,g.get(L));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(d.keys()).find(L=>L.toLowerCase()=="content-type"),D=o.FormData&&a instanceof o.FormData,!(Array.prototype.indexOf.call(m0,h,void 0)>=0)||g||D||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[L,z]of d)this.g.setRequestHeader(L,z);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(a),this.v=!1}catch(L){am(this,L)}};function am(a,h){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=h,a.o=5,lm(a),Aa(a)}function lm(a){a.A||(a.A=!0,Ke(a,"complete"),Ke(a,"error"))}t.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=a||7,Ke(this,"complete"),Ke(this,"abort"),Aa(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Aa(this,!0)),De.Z.N.call(this)},t.Ca=function(){this.u||(this.B||this.v||this.j?um(this):this.Xa())},t.Xa=function(){um(this)};function um(a){if(a.h&&typeof s<"u"){if(a.v&&Zn(a)==4)setTimeout(a.Ca.bind(a),0);else if(Ke(a,"readystatechange"),Zn(a)==4){a.h=!1;try{const L=a.ca();e:switch(L){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var h=!0;break e;default:h=!1}var d;if(!(d=h)){var g;if(g=L===0){let z=String(a.D).match(Jp)[1]||null;!z&&o.self&&o.self.location&&(z=o.self.location.protocol.slice(0,-1)),g=!p0.test(z?z.toLowerCase():"")}d=g}if(d)Ke(a,"complete"),Ke(a,"success");else{a.o=6;try{var D=Zn(a)>2?a.g.statusText:""}catch{D=""}a.l=D+" ["+a.ca()+"]",lm(a)}}finally{Aa(a)}}}}function Aa(a,h){if(a.g){a.m&&(clearTimeout(a.m),a.m=null);const d=a.g;a.g=null,h||Ke(a,"ready");try{d.onreadystatechange=null}catch{}}}t.isActive=function(){return!!this.g};function Zn(a){return a.g?a.g.readyState:0}t.ca=function(){try{return Zn(this)>2?this.g.status:-1}catch{return-1}},t.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.La=function(a){if(this.g){var h=this.g.responseText;return a&&h.indexOf(a)==0&&(h=h.substring(a.length)),GI(h)}};function cm(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.F){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function g0(a){const h={};a=(a.g&&Zn(a)>=2&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<a.length;g++){if(T(a[g]))continue;var d=e0(a[g]);const D=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const L=h[D]||[];h[D]=L,L.push(d)}Q(h,function(g){return g.join(", ")})}t.ya=function(){return this.o},t.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Ws(a,h,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||h}function hm(a){this.za=0,this.i=[],this.j=new Ls,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Ws("failFast",!1,a),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Ws("baseRetryDelayMs",5e3,a),this.Za=Ws("retryDelaySeedMs",1e4,a),this.Ta=Ws("forwardChannelMaxRetries",2,a),this.va=Ws("forwardChannelRequestTimeoutMs",2e4,a),this.ma=a&&a.xmlHttpFactory||void 0,this.Ua=a&&a.Rb||void 0,this.Aa=a&&a.useFetchStreams||!1,this.O=void 0,this.L=a&&a.supportsCrossDomainXhr||!1,this.M="",this.h=new Kp(a&&a.concurrentRequestLimit),this.Ba=new f0,this.S=a&&a.fastHandshake||!1,this.R=a&&a.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=a&&a.Pb||!1,a&&a.ua&&this.j.ua(),a&&a.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&a&&a.detectBufferingProxy||!1,this.ia=void 0,a&&a.longPollingTimeout&&a.longPollingTimeout>0&&(this.ia=a.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}t=hm.prototype,t.ka=8,t.I=1,t.connect=function(a,h,d,g){ft(0),this.W=a,this.H=h||{},d&&g!==void 0&&(this.H.OSID=d,this.H.OAID=g),this.F=this.X,this.J=wm(this,null,this.W),Ra(this)};function vc(a){if(dm(a),a.I==3){var h=a.V++,d=ln(a.J);if(Te(d,"SID",a.M),Te(d,"RID",h),Te(d,"TYPE","terminate"),qs(a,d),h=new Yn(a,a.j,h),h.M=2,h.A=Ia(ln(d)),d=!1,o.navigator&&o.navigator.sendBeacon)try{d=o.navigator.sendBeacon(h.A.toString(),"")}catch{}!d&&o.Image&&(new Image().src=h.A,d=!0),d||(h.g=Em(h.j,null),h.g.ea(h.A)),h.F=Date.now(),Ta(h)}vm(a)}function Ca(a){a.g&&(Ec(a),a.g.cancel(),a.g=null)}function dm(a){Ca(a),a.v&&(o.clearTimeout(a.v),a.v=null),Pa(a),a.h.cancel(),a.m&&(typeof a.m=="number"&&o.clearTimeout(a.m),a.m=null)}function Ra(a){if(!Gp(a.h)&&!a.m){a.m=!0;var h=a.Ea;M||y(),U||(M(),U=!0),v.add(h,a),a.D=0}}function y0(a,h){return Qp(a.h)>=a.h.j-(a.m?1:0)?!1:a.m?(a.i=h.G.concat(a.i),!0):a.I==1||a.I==2||a.D>=(a.Sa?0:a.Ta)?!1:(a.m=Vs(c(a.Ea,a,h),_m(a,a.D)),a.D++,!0)}t.Ea=function(a){if(this.m)if(this.m=null,this.I==1){if(!a){this.V=Math.floor(Math.random()*1e5),a=this.V++;const D=new Yn(this,this.j,a);let L=this.o;if(this.U&&(L?(L=W(L),An(L,this.U)):L=this.U),this.u!==null||this.R||(D.J=L,L=null),this.S)e:{for(var h=0,d=0;d<this.i.length;d++){t:{var g=this.i[d];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(h+=g,h>4096){h=d;break e}if(h===4096||d===this.i.length-1){h=d+1;break e}}h=1e3}else h=1e3;h=pm(this,D,h),d=ln(this.J),Te(d,"RID",a),Te(d,"CVER",22),this.G&&Te(d,"X-HTTP-Session-Id",this.G),qs(this,d),L&&(this.R?h="headers="+bs(om(L))+"&"+h:this.u&&_c(d,this.u,L)),mc(this.h,D),this.Ra&&Te(d,"TYPE","init"),this.S?(Te(d,"$req",h),Te(d,"SID","null"),D.U=!0,hc(D,d,null)):hc(D,d,h),this.I=2}}else this.I==3&&(a?fm(this,a):this.i.length==0||Gp(this.h)||fm(this))};function fm(a,h){var d;h?d=h.l:d=a.V++;const g=ln(a.J);Te(g,"SID",a.M),Te(g,"RID",d),Te(g,"AID",a.K),qs(a,g),a.u&&a.o&&_c(g,a.u,a.o),d=new Yn(a,a.j,d,a.D+1),a.u===null&&(d.J=a.o),h&&(a.i=h.G.concat(a.i)),h=pm(a,d,1e3),d.H=Math.round(a.va*.5)+Math.round(a.va*.5*Math.random()),mc(a.h,d),hc(d,g,h)}function qs(a,h){a.H&&B(a.H,function(d,g){Te(h,g,d)}),a.l&&B({},function(d,g){Te(h,g,d)})}function pm(a,h,d){d=Math.min(a.i.length,d);const g=a.l?c(a.l.Ka,a.l,a):null;e:{var D=a.i;let ie=-1;for(;;){const je=["count="+d];ie==-1?d>0?(ie=D[0].g,je.push("ofs="+ie)):ie=0:je.push("ofs="+ie);let ve=!0;for(let Ge=0;Ge<d;Ge++){var L=D[Ge].g;const un=D[Ge].map;if(L-=ie,L<0)ie=Math.max(0,D[Ge].g-100),ve=!1;else try{L="req"+L+"_"||"";try{var z=un instanceof Map?un:Object.entries(un);for(const[Yr,er]of z){let tr=er;l(er)&&(tr=oc(er)),je.push(L+Yr+"="+encodeURIComponent(tr))}}catch(Yr){throw je.push(L+"type="+encodeURIComponent("_badmap")),Yr}}catch{g&&g(un)}}if(ve){z=je.join("&");break e}}z=void 0}return a=a.i.splice(0,d),h.G=a,z}function mm(a){if(!a.g&&!a.v){a.Y=1;var h=a.Da;M||y(),U||(M(),U=!0),v.add(h,a),a.A=0}}function wc(a){return a.g||a.v||a.A>=3?!1:(a.Y++,a.v=Vs(c(a.Da,a),_m(a,a.A)),a.A++,!0)}t.Da=function(){if(this.v=null,gm(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var a=4*this.T;this.j.info("BP detection timer enabled: "+a),this.B=Vs(c(this.Wa,this),a)}},t.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,ft(10),Ca(this),gm(this))};function Ec(a){a.B!=null&&(o.clearTimeout(a.B),a.B=null)}function gm(a){a.g=new Yn(a,a.j,"rpc",a.Y),a.u===null&&(a.g.J=a.o),a.g.P=0;var h=ln(a.na);Te(h,"RID","rpc"),Te(h,"SID",a.M),Te(h,"AID",a.K),Te(h,"CI",a.F?"0":"1"),!a.F&&a.ia&&Te(h,"TO",a.ia),Te(h,"TYPE","xmlhttp"),qs(a,h),a.u&&a.o&&_c(h,a.u,a.o),a.O&&(a.g.H=a.O);var d=a.g;a=a.ba,d.M=1,d.A=Ia(ln(h)),d.u=null,d.R=!0,Hp(d,a)}t.Va=function(){this.C!=null&&(this.C=null,Ca(this),wc(this),ft(19))};function Pa(a){a.C!=null&&(o.clearTimeout(a.C),a.C=null)}function ym(a,h){var d=null;if(a.g==h){Pa(a),Ec(a),a.g=null;var g=2}else if(pc(a.h,h))d=h.G,Yp(a.h,h),g=1;else return;if(a.I!=0){if(h.o)if(g==1){d=h.u?h.u.length:0,h=Date.now()-h.F;var D=a.D;g=wa(),Ke(g,new Up(g,d)),Ra(a)}else mm(a);else if(D=h.m,D==3||D==0&&h.X>0||!(g==1&&y0(a,h)||g==2&&wc(a)))switch(d&&d.length>0&&(h=a.h,h.i=h.i.concat(d)),D){case 1:Qr(a,5);break;case 4:Qr(a,10);break;case 3:Qr(a,6);break;default:Qr(a,2)}}}function _m(a,h){let d=a.Qa+Math.floor(Math.random()*a.Za);return a.isActive()||(d*=2),d*h}function Qr(a,h){if(a.j.info("Error code "+h),h==2){var d=c(a.bb,a),g=a.Ua;const D=!g;g=new Xn(g||"//www.google.com/images/cleardot.gif"),o.location&&o.location.protocol=="http"||Fs(g,"https"),Ia(g),D?h0(g.toString(),d):d0(g.toString(),d)}else ft(2);a.I=0,a.l&&a.l.pa(h),vm(a),dm(a)}t.bb=function(a){a?(this.j.info("Successfully pinged google.com"),ft(2)):(this.j.info("Failed to ping google.com"),ft(1))};function vm(a){if(a.I=0,a.ja=[],a.l){const h=Xp(a.h);(h.length!=0||a.i.length!=0)&&(N(a.ja,h),N(a.ja,a.i),a.h.i.length=0,I(a.i),a.i.length=0),a.l.oa()}}function wm(a,h,d){var g=d instanceof Xn?ln(d):new Xn(d);if(g.g!="")h&&(g.g=h+"."+g.g),Us(g,g.u);else{var D=o.location;g=D.protocol,h=h?h+"."+D.hostname:D.hostname,D=+D.port;const L=new Xn(null);g&&Fs(L,g),h&&(L.g=h),D&&Us(L,D),d&&(L.h=d),g=L}return d=a.G,h=a.wa,d&&h&&Te(g,d,h),Te(g,"VER",a.ka),qs(a,g),g}function Em(a,h,d){if(h&&!a.L)throw Error("Can't create secondary domain capable XhrIo object.");return h=a.Aa&&!a.ma?new De(new yc({ab:d})):new De(a.ma),h.Fa(a.L),h}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function Tm(){}t=Tm.prototype,t.ra=function(){},t.qa=function(){},t.pa=function(){},t.oa=function(){},t.isActive=function(){return!0},t.Ka=function(){};function ka(){}ka.prototype.g=function(a,h){return new Nt(a,h)};function Nt(a,h){we.call(this),this.g=new hm(h),this.l=a,this.h=h&&h.messageUrlParams||null,a=h&&h.messageHeaders||null,h&&h.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=h&&h.initMessageHeaders||null,h&&h.messageContentType&&(a?a["X-WebChannel-Content-Type"]=h.messageContentType:a={"X-WebChannel-Content-Type":h.messageContentType}),h&&h.sa&&(a?a["X-WebChannel-Client-Profile"]=h.sa:a={"X-WebChannel-Client-Profile":h.sa}),this.g.U=a,(a=h&&h.Qb)&&!T(a)&&(this.g.u=a),this.A=h&&h.supportsCrossDomainXhr||!1,this.v=h&&h.sendRawJson||!1,(h=h&&h.httpSessionIdParam)&&!T(h)&&(this.g.G=h,a=this.h,a!==null&&h in a&&(a=this.h,h in a&&delete a[h])),this.j=new Di(this)}p(Nt,we),Nt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},Nt.prototype.close=function(){vc(this.g)},Nt.prototype.o=function(a){var h=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.v&&(d={},d.__data__=oc(a),a=d);h.i.push(new r0(h.Ya++,a)),h.I==3&&Ra(h)},Nt.prototype.N=function(){this.g.l=null,delete this.j,vc(this.g),delete this.g,Nt.Z.N.call(this)};function Im(a){ac.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var h=a.__sm__;if(h){e:{for(const d in h){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,h=h!==null&&a in h?h[a]:void 0),this.data=h}else this.data=a}p(Im,ac);function Sm(){lc.call(this),this.status=1}p(Sm,lc);function Di(a){this.g=a}p(Di,Tm),Di.prototype.ra=function(){Ke(this.g,"a")},Di.prototype.qa=function(a){Ke(this.g,new Im(a))},Di.prototype.pa=function(a){Ke(this.g,new Sm)},Di.prototype.oa=function(){Ke(this.g,"b")},ka.prototype.createWebChannel=ka.prototype.g,Nt.prototype.send=Nt.prototype.o,Nt.prototype.open=Nt.prototype.m,Nt.prototype.close=Nt.prototype.close,zE=function(){return new ka},BE=function(){return wa()},jE=qr,md={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Ea.NO_ERROR=0,Ea.TIMEOUT=8,Ea.HTTP_ERROR=6,vl=Ea,jp.COMPLETE="complete",UE=jp,Lp.EventType=Ds,Ds.OPEN="a",Ds.CLOSE="b",Ds.ERROR="c",Ds.MESSAGE="d",we.prototype.listen=we.prototype.J,lo=Lp,De.prototype.listenOnce=De.prototype.K,De.prototype.getLastError=De.prototype.Ha,De.prototype.getLastErrorCode=De.prototype.ya,De.prototype.getStatus=De.prototype.ca,De.prototype.getResponseJson=De.prototype.La,De.prototype.getResponseText=De.prototype.la,De.prototype.send=De.prototype.ea,De.prototype.setWithCredentials=De.prototype.Fa,FE=De}).apply(typeof Qa<"u"?Qa:typeof self<"u"?self:typeof window<"u"?window:{});const fy="@firebase/firestore",py="4.9.2";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
